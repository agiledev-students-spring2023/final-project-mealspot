...
This wireframe represents the screen where a user can choose to swap a meal in their meal plan for the day with a newly created meal that is saved as a recipe after clicking the save meal button.
